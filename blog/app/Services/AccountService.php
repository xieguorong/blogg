...
class AccountService {
	...
	public function queryAcccount($arrData){

        $AccountDao = new AccountDao();
		return $AccountDao->queryAcccount($arrData);
	}
	 ...
	 * @return array
	 */
	public function getAcccountById($id){
		$AccountDao = new AccountDao();
		return $AccountDao->getAcccountById($id);
	}
	...
	public function createAccountW($arrData){
        DB::transaction(function() use ($arrData) {
            $arrAccount = array();
            $arrAccount['sys_account_name'] 	= $arrData['sys_account_name'];
            $arrAccount['sys_account_pic']      = $arrData['sys_account_pic'];
            $arrAccount['sys_account_addr']      = $arrData['sys_account_addr'];
            $arrAccount['sys_account_email']    = "";
            $arrAccount['sys_account_tel']    = $arrData['sys_account_name'];
            $arrAccount['password'] 			= $arrData['password'];
            $arrAccount['sys_account_status'] 	= 1; //活动状态
            $arrAccount['open_id'] = $arrData['open_id'];
