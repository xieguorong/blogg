...
<body>
	...
	<div class="head">
		...
		<ul class="headlink pull-right">
			...
			<li class="link_3"><a href="{{url("admin/pass")}}">修改密码</a></li>
			<li class="link_4"><a href="{{url("admin/quite")}}">退出</a></li>
		</ul>
	</div>
	<!-- 头部页面结束 -->
	<div class="leftmenu">
		<div class="leftmenu_0">
			...
			<dl>
				...
				<dd>
					<ul class="clearfix">
						<li><a href="javascript:;" _link="introduce.html">公司介绍</a></li>
	...
	<div class="rightmain" id="rightmain">
		<div class="rightcontent">
			<iframe src="{{url('admin/index')}}" id="main" name="main" frameborder="0" scrolling="yes"></iframe>
		</div>
	</div>
	 ...
	 <script src="/front/public/js/jquery-3.1.1.js"></script>
	  ...
	  <script src="/front/public/js/banner.js"></script>
